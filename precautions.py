...
frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=280, height=120, bd=5, font=('times', 14, ' bold '),bg="grey")
...
def Fraud():
    ...
    my_link=tk.Label(root,text='Mussels',bg="white",fg="blue",width=20,cursor='hand2',height=1,font=("Times", 20, 'underline'))
    my_link.place(x=350,y=100)
    # grid(padx=400,pady=10)
    
    my_link.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=VqeIM4iVUgg"))


    my_link2=tk.Label(root,text='lobster_bisque',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=150)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=iS7e_3iySi0"))    
   
    my_link2=tk.Label(root,text='chocolate_cake',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=200)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=vI5w-fK25w4")) 
    
    
    my_link2=tk.Label(root,text='crab_cakes',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=250)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=0eJ6mw3dOyg"))
    
    my_link2=tk.Label(root,text='fried_rice',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=300)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=hoZccEa0Pqo"))
    
    my_link2=tk.Label(root,text='Ice_creame',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=350)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=7gJIyHnD710"))
    
    my_link2=tk.Label(root,text='Garlic_Bread',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=400)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=gQFbV42zSj8"))
    
    my_link2=tk.Label(root,text='Pizza',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=450)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=PK0czgdbHoY"))
    
    my_link2=tk.Label(root,text='Samosa',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=500)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=n5F4ysfl_5k"))
    
    my_link2=tk.Label(root,text='Onion_Rings',bg="white",fg="blue",cursor='hand2',width=20,height=1,font=("Times", 20, 'underline'))
    my_link2.place(x=350,y=550)
    
    my_link2.bind('<Button-1>',
        lambda x:webbrowser.open_new("https://www.youtube.com/watch?v=VF4L-d5ZsNY"))
